...
export default function ArchitechureSec() {
  return (
    <div className="relative mx-auto my-20 max-w-[1246px] rounded-2xl overflow-hidden shadow-2xl">
      ...
      >
        <path d="M 1440 0 Q 1200 150, 1200 300 Q 1200 450, 1200 600 Q 1200 750, 1200 900" className="fill-none stroke-white/20" strokeWidth="2" strokeLinecap="round" />
        <path d="M 1440 0 Q 1250 150, 1250 300 Q 1250 450, 1250 600 Q 1250 750, 1250 900" className="fill-none stroke-white/18" strokeWidth="2" strokeLinecap="round" />
        <path d="M 1440 0 Q 1300 150, 1300 300 Q 1300 450, 1300 600 Q 1300 750, 1300 900" className="fill-none stroke-white/15" strokeWidth="2" strokeLinecap="round" />
        <path d="M 1440 0 Q 1350 150, 1350 300 Q 1350 450, 1350 600 Q 1350 750, 1350 900" className="fill-none stroke-white/12" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M 1440 0 Q 1380 150, 1380 300 Q 1380 450, 1380 600 Q 1380 750, 1380 900" className="fill-none stroke-white/10" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M 1440 0 Q 1410 150, 1410 300 Q 1410 450, 1410 600 Q 1410 750, 1410 900" className="fill-none stroke-white/8" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
      ...
      <div className="relative z-10 px-6 py-12 flex flex-col items-center">
        ...
        <div className="relative w-full h-auto">
          <div className="absolute left-0 top-1/2 -translate-y-1/2 w-72 opacity-90 transform -translate-x-4 scale-90 shadow-2xl rounded-lg overflow-hidden">
            <img src="/ARCHITECHURE-SEC/ARCHITECHURE-LEFT.png" alt="Left Dashboard" className="w-full h-auto" />
          </div>

          <div className="relative mx-auto w-full max-w-2xl shadow-2xl rounded-lg overflow-hidden border-4 border-white/30">
            <img src="/ARCHITECHURE-SEC/ARCHITECHURE-MAIN.png" alt="Main Dashboard" className="w-full h-auto" />
          </div>
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-72 opacity-90 transform translate-x-4 scale-90 shadow-2xl rounded-lg overflow-hidden">
            <img src="/ARCHITECHURE-SEC/ARCHITECHURE-RIGHT.png" alt="Right Dashboard" className="w-full h-auto" />
          </div>
        </div>
      </div>
    </div>
